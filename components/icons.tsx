...
export const LogoMoment: React.FC<IconSvgProps> = ({ size = 24, width, height, ...props }) => (
  <svg
    width={size || width}
    height={size || height}
    viewBox="0 0 256 256"
  ...
  >
    ...
    {/* Тень на карте */}
    <ellipse cx="128" cy="214" rx="62" ry="16" fill="url(#shadowGradient)" />
    ...
    {/* Внутренний круг */}
    <circle cx="128" cy="96" r="38" fill="url(#innerCircle)" />
...
export const Doc: React.FC<IconSvgProps> = ({ size = 24, width, height, ...props }) => (
  <svg
    direction="ltr"
    height={size || height}
    version="1.1"
...
export const PostgreSQL: React.FC<IconSvgProps> = ({ size = 36, width, height, ...props }) => (
  <svg
    //    fill="none"
    height={size || height}
...
export const IndikatorClose: React.FC<IconSvgProps> = ({ size = 36, width, height, ...props }) => (
  <svg
    fill="none"
    height={size || height}
...
export const IndikatorOpen: React.FC<IconSvgProps> = ({ size = 36, width, height, ...props }) => (
  <svg
    fill="none"
    height={size || height}
...
export const Logo: React.FC<IconSvgProps> = ({ size = 36, width, height, ...props }) => (
  <svg fill="none" height={size || height} viewBox="0 0 150 82" width={size || width} {...props}>
    <path
      clipRule="evenodd"
...
export const GitlabIcon: React.FC<IconSvgProps> = ({ size = 24, width, height, ...props }) => {
  return (
    <svg
      fill="none"
      height={size || height}
...
*/
export const LoginIcon = ({ size = 24, width, height, ...props }: IconSvgProps) => (
  <svg
    fill="none"
    focusable="false"
    height={size || height}
...
export const EraserIcon = ({ size = 24, width, height, ...props }: IconSvgProps) => {
  return (
    <svg
      fill="none"
      height={size || height}
...
export const ChevronLeftIcon = ({ size = 24, width, height, ...props }: IconSvgProps) => {
  return (
    <svg
      fill="none"
      height={size || height}
...
export const ChevronRightIcon = ({ size = 24, width, height, ...props }: IconSvgProps) => {
  return (
    <svg
      fill="none"
      height={size || height}
