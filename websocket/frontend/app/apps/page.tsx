    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <header className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-4 py-3">
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <span className="text-sm font-medium text-gray-700 dark:text-gray-300">{currentUsername}</span>
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
          <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
            <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Alle Anwendungen ({usersMap.size})</h2>
          </div>
          ...
          <div className="p-6">
            ...
            {error && (
              <div className="bg-red-50 dark:bg-red-900/30 text-red-600 dark:text-red-400 px-4 py-3 rounded-lg mb-4">
                {error}
                <button onClick={() => loadUsers(sessionId)} className="ml-2 underline hover:no-underline">
                  Try again
                </button>
              </div>
            )}
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <div className="flex items-center gap-2">
                          ...
                          {user.host && (
                            <a
                              href={user.host.startsWith("http") ? user.host : `http://${user.host}`}
                              target="_blank"
                              rel="noopener noreferrer"
                              onClick={(e) => e.stopPropagation()}
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      {user.isOnline && (
                        <div className="text-right">
                          <div className="text-sm font-medium text-gray-900 dark:text-white">CPU: {user.status}%</div>
                          <div className="w-24 h-2 bg-gray-200 dark:bg-gray-600 rounded-full overflow-hidden">
                            <div
                              className={`h-full transition-all duration-300 ${
                                user.status > 80 ? "bg-red-500" : user.status > 50 ? "bg-yellow-500" : "bg-green-500"
                              }`}
      ...
      {showAddUser && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 w-full max-w-md">
            <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-4">Neue Anwendung hinzufügen</h2>
      ...
      {showEditUser && selectedUser && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 w-full max-w-md">
            <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-4">Edit User: {selectedUser.username}</h2>
